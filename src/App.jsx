...
function App() {
  ...
  useEffect(() => {
    const handleLoad = () => {
      // Small delay makes the preloader exit smoother.
  ...
  return (
    <>
      ...
      <div className="relative flex flex-col min-h-screen text-white selection:bg-cyan-400 selection:text-black">
        ...
        {/* Dark Overlay */}
        <div className="fixed inset-0 -z-10 bg-[#050A15]/80 pointer-events-none" />

        {/* Fluid Cursor Effect - Above background, below content */}
        <FluidCursor />
